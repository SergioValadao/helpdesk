...
public class ChamadosServices {
	...
	public Chamados delete(Integer id) {
		...
		if(chamado.equals(null)) {
			throw new DataIntegrityViolationException("Registro não encontrado! Verifique");
		}
	...
	public Chamados update(Integer id, ChamadosDTO chaDTO) {
		...
		if(cha.equals(null)) {
			throw new DataIntegrityViolationException("Registro não encontrado para exclusão");
		}
